...
public class Controller extends HttpServlet {
    ...
    public void init() throws ServletException {
		...
		Action.add(new Summary_Action(model));
		Action.add(new search_skill(model));
		Action.add(new search_skill1(model));
		Action.add(new Search_Action(model));
		Action.add(new work_action(model));
...
/**
        if (action.equals("login.do") | action.equals("index.do")) {
